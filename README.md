...
* "показать веб таблицу" - отображение таблицы с отсортированными данными по умолчанию в соответствии с требованиями [заданием №1](#Задание_№1), так же доступна пользовательская сортровка в окне браузера по 4ем параметрам, где к каждому параметру можно применить дополнительную сортировку по "возрастанию" или "убыванию". В качестве одного из четырех параметров можно выбрать следующие колонки: 'area', 'cluster', 'cluster_name', 'keyword', 'count', 'x', 'y', 'color';
